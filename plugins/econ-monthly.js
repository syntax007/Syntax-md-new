...
if (new Date - user.lastmonthly < 432000000) return await conn.reply(m.chat, `𝙔𝙊𝙐 𝘼𝙇𝙍𝙀𝘼𝘿𝙔 𝙍𝙀𝘾𝙀𝙄𝙑𝙀𝘿 𝙔𝙊𝙐𝙍 𝙈𝙊𝙉𝙏𝙃𝙇𝙔 𝙍𝙀𝙒𝘼𝙍𝘿 🌅\n\n𝘾𝙊𝙈𝙀 𝘽𝘼𝘾𝙆 𝙄𝙉\n${clockString(time - new Date() * 1)}`, fkontak,  m)
let pp = 'https://telegra.ph/file/85ffd50bf5ab99232f6c7.jpg'
let texto = ''
...
let text = `╭━━🏄‍♂️━⛷️━🤾‍♀️━━⬣
┃ 🎖️ 𝙈𝙊𝙉𝙏𝙃𝙇𝙔 𝙍𝙀𝙒𝘼𝙍𝘿!!!
┃ *${premium ? '🎟️ Reward Premium' : '🆓 free reward'}*
┃ ${texto}
