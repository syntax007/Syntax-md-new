...
if (new Date - user.lastweekly < 259200000) return await conn.reply(m.chat, `𝙔𝙊𝙐 𝘼𝙇𝙍𝙀𝘼𝘿𝙔 𝙍𝙀𝘾𝙀𝙄𝙑𝙀𝘿 𝙔𝙊𝙐𝙍 𝙒𝙀𝙀𝙆𝙇𝙔 𝙍𝙀𝙒𝘼𝙍𝘿 ⛅\n\n𝘾𝙊𝙈𝙀 𝘽𝘼𝘾𝙆 𝙄𝙉\n${clockString(time - new Date() * 1)}`, m)
...
let pp = 'https://telegra.ph/file/8f2a32d6119d545f64513.jpg'
...
function clockString(ms) {
  ...
  return ['┃⇢ ', ye, ' *🗓️ : Year*\n', '┃⇢ ', mo, ' *⛅ : Month*\n', '┃⇢ ', d, ' *☀️: Days*\n', '┃⇢ ', h, ' *⏰ : Hours*\n', '┃⇢ ', m, ' *🕐 : Minutes*\n', '┃⇢ ', s, ' *⏱️ : Seconds*'].map(v => v.toString().padStart(2, 0)).join('')
}