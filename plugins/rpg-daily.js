...
if (new Date - user.lastclaim < 7200000) return await conn.reply(m.chat, `𝙔𝙊𝙐 𝘼𝙇𝙍𝙀𝘼𝘿𝙔 𝘾𝙇𝘼𝙄𝙈𝙀𝘿 𝙔𝙊𝙐𝙍 𝙂𝙄𝙁𝙏 🎁\n𝘾𝙊𝙈𝙀 𝘽𝘼𝘾𝙆 𝙄𝙉 *${msToTime(time - new Date())}* 𝙏𝙊 𝘾𝙇𝘼𝙄𝙈 𝘼𝙂𝘼𝙄𝙉`,m)
...
let text = `╭━━🎁━🎁━🎁━━⬣
┃ ✨ 𝙔𝙊𝙐 𝙂𝙀𝙏 𝘼 𝙂𝙄𝙁𝙏!!
┃ *${premium ? '🎟️ Recompensa Premium' : '🆓 free reward'}*
┃ ${texto}
╰━━🎁━🎁━🎁━━⬣

🎟️ 𝗣 𝗥 𝗘 𝗠 𝗜 𝗨 𝗠 ⇢ ${premium ? '✅' : '❌'}\n𝙎𝙮𝙣𝙩𝙖𝙭-𝙢𝙙`
let img = 'https://telegra.ph/file/3db0f0ef58d8143f31ebd.jpg'
await conn.sendFile(m.chat, img, 'syntax.jpg', text, fkontak)
