...
*┈┈┈┈┈┈┈┈┈*
     ...
     ${arr.slice(6).join('')}
*┈┈┈┈┈┈┈┈┈*
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} 😎🏆 *WON!!*\n*FOR HAVING WON YOU GET*\n\n💎 *${dia2} diamonds*\n🪙 *${tok2} Tokens*\n🐈 *${gata2} Coins*\n⚡ *${expp2} Exp*` : isTie ? `*A TIE!!* 🤨\n*FOR ENDING IN A TIE BOTH GET*\n\n💎 *${dia} diamonds*\n🪙 *${tok} Tokens*\n💸 *${gata} Coins*\n⚡ *${expp} Exp*` : `🪄 *TURN OF* @${room.game.currentTurn.split('@')[0]}`}
`.trim()
