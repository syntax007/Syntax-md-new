...
if (!text) throw `╭── ⋅ ⋅ ── ✩ ── ⋅ ⋅ ──╮𝙒𝙍𝙄𝙏𝙀 𝙏𝙃𝙀 𝙉𝘼𝙈𝙀 𝙊𝙍 𝙏𝙄𝙏𝙇𝙀╰── ⋅ ⋅ ── ✩ ── ⋅ ⋅ ──╯\n𝙀𝙓𝘼𝙈𝙋𝙇𝙀\n*${usedPrefix + command} believer*`
try {
...
await await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `╭━❰    ❱━⬣\n┃ 💜 𝙏𝙄𝙏𝙇𝙀\n┃ \n╰━━━━━❰ 𝙎𝙮𝙣𝙩𝙖𝙭-𝙢𝙙 ❱━━━━⬣`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
} catch {   
try {  
let mediaa = await ytMp4(yt_play[0].url)
await conn.sendMessage(m.chat, { video: { url: mediaa.result }, fileName: `error.mp4`, caption: `*Downloaded by Syntax-md*`, thumbnail: mediaa.thumb, mimetype: 'video/mp4' }, { quoted: m })     
} catch {  
try {
...
await conn.sendMessage(m.chat, { video: { url: n2 }, fileName: `${n}.mp4`, mimetype: 'video/mp4', caption: `╭━❰  𝙎𝙮𝙣𝙩𝙖𝙭-𝙢𝙙❱━⬣\n┃ 💜 𝙏𝙄𝙏𝙇𝙀\n┃ \n╰━━━━━❰ 𝙎𝙮𝙣𝙩𝙖𝙭-𝙢𝙙 ❱━━━━⬣`, thumbnail: await fetch(n4) }, { quoted: m })
} catch {
}}}    
}} catch {
handler.limit = 0
